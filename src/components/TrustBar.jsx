  ...
  return (
    <div className="py-6 md:py-10 bg-white dark:bg-[#020617] border-y border-gray-100 dark:border-white/5 transition-colors duration-300">
      <div className="max-w-5xl mx-auto px-4 overflow-hidden">
        <p className="text-center text-slate-400 dark:text-gray-900 text-xs md:text-sm tracking-widest uppercase mb-4 md:mb-8 font-semibold transition-colors">Trusted by innovators in</p>
